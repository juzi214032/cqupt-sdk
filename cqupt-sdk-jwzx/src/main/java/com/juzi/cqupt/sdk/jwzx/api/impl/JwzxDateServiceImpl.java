...
import com.juzi.cqupt.sdk.jwzx.util.RegexUtil;
...
public class JwzxDateServiceImpl implements JwzxDateService {
    ...
    @Override
    public LocalDate getJwzxDate(Integer week, Integer day) {
        LocalDate initTime = this.getInitTime();
        int countDay = (week - 1) * 7 + day - 1;
        LocalDate localDate = initTime.plusDays(countDay);
        return localDate;
    }
